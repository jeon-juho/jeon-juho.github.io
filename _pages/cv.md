...
* **180 nm CMOS 10-bit SAR ADC** — final year thesis, Sep 2023 – May 2024
  ...
  * Designed and independently verified a 10-bit monotonic-switching SAR ADC (capacitive DAC, bootstrapped sampling switch, dynamic comparator, asynchronous SAR logic) in Cadence Virtuoso, reaching 9.09 ENOB and 1.92 mW at 2 MS/s.
  * [Project page](/portfolio/sar-adc-10b-180nm/)

Course projects
======
* **28 GHz Differential LNA**, Spring 2026 — RFIC Design (Prof. Chik Patrick Yue), 22 nm TSMC CMOS
  * Differential cascode LNA with inductive source/gate degeneration: 17.4 dB gain, 1.74 dB NF, −14.1 dB S11, 9.16 dBm IIP3 at 22.8 mW. [Project page](/portfolio/lna-28ghz/)
* **Gain-Boosted Folded-Cascode Fully-Differential OTA**, Fall 2024 — Advanced Analog IC Design (Prof. Howard Luong), 90 nm TSMC CMOS
  * 81.6 dB gain, 604 MHz UGF, 61.5° phase margin, 103 dB CMRR and −66 dB THD at 1.93 mW (±1 V supply). [Project page](/portfolio/gain-boosted-ota/)
* **Continuous-Time Gm-C Channel-Selection Filter for UWB**, Fall 2024 — Advanced Analog IC Design (Prof. Howard Luong), 90 nm TSMC CMOS
  * Gm-C UWB bandpass filter (35 kHz – 259 MHz) taken from passive Chebyshev-I prototypes through to transistor-level implementation. [Project page](/portfolio/gmc-uwb-filter/)
* **DC-DC Buck Converter with PWM Voltage-Mode Control**, Fall 2024 — Power Management IC Design (Prof. Wing Hung Ki), 180 nm TSMC CMOS
...
Work experience
======
* **Deloitte Advisory**, Hong Kong — Cyber Security Intern, Feb 2022 – Dec 2022
...
* **Deputy Teaching Assistant Coordinator**, ECE Dept., HKUST, Sep 2025 – Jul 2026
  ...
  * Host the monthly ECE Future Leaders PG Seminar Series.
* **Teaching Assistant**, ELEC3400 Integrated Circuit Designs and Systems, HKUST, Spring 2025
  * Prepared materials, held tutorial sessions and reinforced lectures. Supervisor: Prof. Howard Luong.
* **ECE Student Ambassador**, ECE Dept., HKUST, Sep 2023 – Jun 2024
  * Advised junior students on academic and non-academic matters; supported departmental outreach.

Honors and awards
======
* **First Runner-Up — ECE Best Final Year Project/Thesis Award**, ECE Dept., HKUST, Jun 2024
* **Dean's List**, ECE Dept., HKUST, Sep 2023
* **Top 5 Innovative Solution — Sustainability Smart Campus Competition**, HKUST, Nov 2021

Skills
======
* **Circuit design**: analog/mixed-signal CMOS IC design, SAR ADCs and data converters, mm-wave RF circuits (LNA), power management ICs, PCB design, FPGA
