...
<figure>
  <img src="/images/portfolio/buck-converter/01-top-level-schematic.png" width="1037" height="957" alt="Buck converter top-level schematic" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/02-power-switch-driver.png" width="1135" height="532" alt="Power transistor driver schematic" loading="lazy">
  <figcaption>Four-stage tapered inverter chain driving the power transistor.</figcaption>
</figure>

<figure>
  <img src="/images/portfolio/buck-converter/09-driver-delay-sim.png" width="1131" height="517" alt="Power transistor driver simulation" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/03-active-diode.png" width="1135" height="578" alt="Active diode with control circuit" loading="lazy">
  <figcaption>Active diode and its comparator-based control circuit.</figcaption>
</figure>

<figure>
  <img src="/images/portfolio/buck-converter/10-active-diode-iv.png" width="1131" height="516" alt="Active diode I-V characteristic" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/04-error-amplifier.png" width="1135" height="619" alt="Error amplifier schematic" loading="lazy">
  <figcaption>Two-stage error amplifier.</figcaption>
</figure>

<figure>
  <img src="/images/portfolio/buck-converter/12-error-amp-bode.png" width="1135" height="517" alt="Error amplifier Bode plot" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/05-type-i-compensator.png" width="511" height="398" alt="Type I compensator" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/06-rtct-oscillator.png" width="1135" height="364" alt="RTCT oscillator schematic" loading="lazy">
  <figcaption>RTCT oscillator generating the ramp and clock signals.</figcaption>
</figure>

<figure>
  <img src="/images/portfolio/buck-converter/11-oscillator-transient.png" width="1133" height="517" alt="RTCT oscillator transient response" loading="lazy">
  <figcaption>Oscillator transient: two synchronous 1 MHz signals, with the ramp swinging from 150.3 mV to 1.327 V.</figcaption>
</figure>

<figure>
  <img src="/images/portfolio/buck-converter/07-pwm-comparator.png" width="613" height="444" alt="PWM comparator schematic" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/08-sr-latch.png" width="1135" height="690" alt="NOR gate SR latch schematic" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/13-ccm-steady-state.png" width="1135" height="517" alt="CCM steady-state operation at 500 mA" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/14-dcm-operation.png" width="1135" height="517" alt="DCM operation at 100 mA" loading="lazy">
...
<figure>
  <img src="/images/portfolio/buck-converter/15-line-transient.png" width="1135" height="517" alt="Line transient response" loading="lazy">
  <figcaption>Line transient response for a 3.0 V → 3.6 V input step.</figcaption>
</figure>

<figure>
  <img src="/images/portfolio/buck-converter/16-load-transient.png" width="1135" height="517" alt="Load transient response" loading="lazy">
